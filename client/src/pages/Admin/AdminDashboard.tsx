        ...
        <div className="space-y-8">
            ...
            <div className="bg-gray-800 rounded-lg border border-gray-700">
                <div className="p-6 border-b border-gray-700 flex justify-between items-center">
                    ...
                    <Link to="/admin/messages" className="text-green-500 hover:text-green-400 text-sm font-medium">
                        View All →
                    </Link>
                </div>
                <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Link to="/admin/about" className="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-lg hover:from-green-700 hover:to-green-800 transition">
                ...
                <Link to="/admin/messages" className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 rounded-lg hover:from-blue-700 hover:to-blue-800 transition">
