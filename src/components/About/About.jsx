    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-5 auto-rows-max mt-12">
                ...
                <p className="col-span-3 flex-1 p-7 mt-7 font-ginora text-[#dddeee] text-center">I&apos;m a passionate programmer and web developer with a hunger for <span className="text-xl font-medium text-[goldenrod]">efficient problem solving</span>. I have <span className="text-xl font-medium text-[goldenrod]">3+</span> years of personal programming experience with <span className="text-xl font-medium text-[goldenrod]">Python</span>! Though I&apos;m currently working with <strong className="text-2xl font-medium text-amber-300">React</strong> based frontend technology, I can <span className="text-xl font-medium text-[magenta]/50">learn any technology</span> within a <span className="text-xl font-medium text-[goldenrod]">short period of time</span> based upon my <strong className="text-xl font-medium text-[orange]">stronger</strong>💪🏿 <strong className="text-xl font-medium text-[greenyellow]/75">foundational</strong> programming and problem solving skill. So, you can simply put your <span className="text-xl font-medium text-[goldenrod]">trust</span> on me to take me in your next project for <strong className="text-xl font-medium text-[orange]">greater</strong> success! I hope,<br />
